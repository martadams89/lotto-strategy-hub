...
const STATIC_FALLBACK_LOTTO: LotteryDraw[] = [
  { date: "2026-05-30", numbers: [5, 12, 19, 33, 44, 58], bonus: 8, stars: [], winners: 1, jackpotAmount: "£3.8M", hasJackpotWinner: true },
  { date: "2026-05-27", numbers: [1, 14, 25, 30, 48, 55], bonus: 12, stars: [], winners: 0, jackpotAmount: "£2.1M", hasJackpotWinner: false },
  { date: "2026-05-23", numbers: [9, 11, 28, 41, 49, 53], bonus: 37, stars: [], winners: 1, jackpotAmount: "£7.4M", hasJackpotWinner: true },
  { date: "2026-05-20", numbers: [14, 21, 35, 42, 47, 51], bonus: 4, stars: [], winners: 0, jackpotAmount: "£5.3M", hasJackpotWinner: false },
  { date: "2026-05-16", numbers: [7, 13, 24, 38, 45, 59], bonus: 2, stars: [], winners: 2, jackpotAmount: "£4.0M", hasJackpotWinner: true },
  { date: "2026-05-13", numbers: [3, 10, 18, 29, 41, 56], bonus: 15, stars: [], winners: 0, jackpotAmount: "£2.0M", hasJackpotWinner: false },
  { date: "2026-05-09", numbers: [12, 16, 22, 35, 48, 50], bonus: 33, stars: [], winners: 1, jackpotAmount: "£11.8M", hasJackpotWinner: true },
  { date: "2026-05-06", numbers: [2, 18, 31, 40, 43, 57], bonus: 19, stars: [], winners: 0, jackpotAmount: "£8.5M", hasJackpotWinner: false },
  { date: "2026-05-02", numbers: [6, 15, 27, 34, 46, 52], bonus: 11, stars: [], winners: 1, jackpotAmount: "£5.1M", hasJackpotWinner: true },
  { date: "2026-04-29", numbers: [8, 17, 26, 39, 48, 54], bonus: 5, stars: [], winners: 0, jackpotAmount: "£2.0M", hasJackpotWinner: false },
  { date: "2026-04-25", numbers: [11, 23, 29, 36, 42, 58], bonus: 49, stars: [], winners: 3, jackpotAmount: "£3.8M", hasJackpotWinner: true },
  { date: "2026-04-22", numbers: [4, 13, 21, 30, 47, 51], bonus: 16, stars: [], winners: 0, jackpotAmount: "£2.0M", hasJackpotWinner: false },
  { date: "2026-04-18", numbers: [10, 24, 32, 45, 50, 56], bonus: 22, stars: [], winners: 1, jackpotAmount: "£15.4M", hasJackpotWinner: true },
  { date: "2026-04-15", numbers: [7, 19, 28, 33, 41, 59], bonus: 14, stars: [], winners: 0, jackpotAmount: "£12.1M", hasJackpotWinner: false },
  { date: "2026-04-11", numbers: [1, 9, 14, 25, 38, 44], bonus: 53, stars: [], winners: 1, jackpotAmount: "£8.7M", hasJackpotWinner: true },
  { date: "2026-04-08", numbers: [15, 20, 31, 40, 48, 57], bonus: 6, stars: [], winners: 0, jackpotAmount: "£5.2M", hasJackpotWinner: false },
  { date: "2026-04-04", numbers: [13, 18, 22, 35, 49, 52], bonus: 29, stars: [], winners: 1, jackpotAmount: "£4.1M", hasJackpotWinner: true },
  { date: "2026-04-01", numbers: [2, 11, 16, 27, 43, 55], bonus: 12, stars: [], winners: 0, jackpotAmount: "£2.0M", hasJackpotWinner: false },
  { date: "2026-03-28", numbers: [8, 14, 21, 30, 44, 58], bonus: 37, stars: [], winners: 2, jackpotAmount: "£11.5M", hasJackpotWinner: true },
  { date: "2026-03-25", numbers: [5, 10, 19, 31, 47, 50], bonus: 41, stars: [], winners: 0, jackpotAmount: "£8.2M", hasJackpotWinner: false },
];

const STATIC_FALLBACK_EURO: LotteryDraw[] = [
  { date: "2026-05-29", numbers: [11, 15, 28, 41, 49], stars: [5, 9], winners: 0, jackpotAmount: "£58M", hasJackpotWinner: false },
  { date: "2026-05-26", numbers: [4, 12, 23, 35, 48], stars: [2, 10], winners: 0, jackpotAmount: "£25M", hasJackpotWinner: false },
  { date: "2026-05-22", numbers: [1, 9, 18, 28, 42], stars: [3, 11], winners: 1, jackpotAmount: "£157M", hasJackpotWinner: true },
  { date: "2026-05-19", numbers: [14, 20, 29, 41, 44], stars: [6, 12], winners: 0, jackpotAmount: "£142M", hasJackpotWinner: false },
  { date: "2026-05-15", numbers: [8, 17, 24, 37, 46], stars: [1, 9], winners: 0, jackpotAmount: "£125M", hasJackpotWinner: false },
  { date: "2026-05-12", numbers: [3, 11, 25, 33, 50], stars: [7, 8], winners: 0, jackpotAmount: "£113M", hasJackpotWinner: false },
  { date: "2026-05-08", numbers: [12, 19, 21, 38, 45], stars: [4, 11], winners: 2, jackpotAmount: "£69M", hasJackpotWinner: true },
  { date: "2026-05-05", numbers: [5, 10, 22, 36, 48], stars: [2, 9], winners: 0, jackpotAmount: "£55M", hasJackpotWinner: false },
  { date: "2026-05-01", numbers: [6, 14, 27, 41, 49], stars: [3, 12], winners: 0, jackpotAmount: "£42M", hasJackpotWinner: false },
  { date: "2026-04-28", numbers: [2, 15, 29, 39, 43], stars: [5, 10], winners: 1, jackpotAmount: "£25M", hasJackpotWinner: true },
  { date: "2026-04-24", numbers: [13, 21, 31, 44, 47], stars: [1, 6], winners: 0, jackpotAmount: "£157M", hasJackpotWinner: false },
  { date: "2026-04-21", numbers: [7, 18, 28, 35, 42], stars: [4, 8], winners: 0, jackpotAmount: "£138M", hasJackpotWinner: false },
  { date: "2026-04-17", numbers: [10, 24, 30, 41, 49], stars: [2, 11], winners: 0, jackpotAmount: "£118M", hasJackpotWinner: false },
  { date: "2026-04-14", numbers: [3, 16, 25, 34, 48], stars: [7, 12], winners: 0, jackpotAmount: "£104M", hasJackpotWinner: false },
  { date: "2026-04-10", numbers: [1, 11, 20, 29, 44], stars: [5, 9], winners: 4, jackpotAmount: "£85M", hasJackpotWinner: true },
  { date: "2026-04-07", numbers: [6, 15, 22, 33, 40], stars: [10, 11], winners: 0, jackpotAmount: "£71M", hasJackpotWinner: false },
  { date: "2026-04-03", numbers: [8, 12, 19, 27, 45], stars: [2, 8], winners: 0, jackpotAmount: "£55M", hasJackpotWinner: false },
  { date: "2026-03-31", numbers: [4, 10, 18, 30, 41], stars: [3, 7], winners: 1, jackpotAmount: "£36M", hasJackpotWinner: true },
  { date: "2026-03-27", numbers: [11, 14, 25, 36, 47], stars: [1, 9], winners: 0, jackpotAmount: "£25M", hasJackpotWinner: false },
  { date: "2026-03-24", numbers: [5, 13, 21, 28, 39], stars: [4, 12], winners: 1, jackpotAmount: "£113M", hasJackpotWinner: true },
];
